...
export type SubmittedResult =
  | {
      ...
      reviewStatus: "pending_review" | "in_review" | "contacted" | "cancelled";
    }
  | {
      kind: "v2";
      requestId: UUID;
...
export type LegacyResult = { kind: "legacy"; instagramUsername: string };
...
export type ApiError = {
  error: {
    code: PublicErrorCode;
    message: string;
    fields?: Partial<Record<"fullName" | "phone" | "email" | "instagramUsername" | "consents", string>>;
  };
  traceId: UUID;
};
